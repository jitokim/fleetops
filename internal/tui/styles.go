...
// visual weight where it mattered (e.g. the ◎ FLEETOPS logo).
var (
	cLine   = lipgloss.Color("#3d5266") // panel borders/hairlines — must stay VISIBLE on any dark terminal bg (was #20303c, which vanished)
